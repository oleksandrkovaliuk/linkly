    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Customize how your vault looks.
        </p>
      </div>
      ...
      <form noValidate className="space-y-6" onSubmit={onSubmit}>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              {...register("name")}
              className="min-w-0 flex-1 rounded-lg border border-border bg-transparent px-3 py-2 text-sm outline-none transition-colors focus:border-foreground/20 placeholder:text-muted-foreground"
